<template>
  ...
  >
    <div class="flex items-center gap-3 mb-4">
      <div class="w-10 h-10 rounded-lg flex items-center justify-center" :class="platform.bgColor">
        <img
          v-if="!imageError"
          :src="platform.icon"
          :alt="platform.name"
