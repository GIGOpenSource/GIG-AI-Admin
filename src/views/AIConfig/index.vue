        ...
        <template #body>
          <div class="relative z-10 w-full max-w-xl rounded-xl bg-white p-6 shadow-lg dark:bg-gray-900">
            ...
            <form @submit.prevent="submitAdd" class="space-y-4">
              ...
              <div>
                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">优先级<span class="text-error-500">*</span></label>
...
async function submitAdd() {
  ...
  if (!form.value.priority || form.value.priority === '') {
    toast.error('请填写优先级', {
      description: '优先级不能为空'
    })
    return
